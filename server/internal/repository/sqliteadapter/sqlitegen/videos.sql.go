...
func (q *Queries) ListVideosForStorageWitness(ctx context.Context, limit int64) ([]ListVideosForStorageWitnessRow, error) {
	rows, err := q.db.QueryContext(ctx, listVideosForStorageWitness, limit)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
