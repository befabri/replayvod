...
func (q *Queries) SetSchedulesPaused(ctx context.Context, schedulesPaused int64) (ServerSetting, error) {
	row := q.db.QueryRowContext(ctx, setSchedulesPaused, schedulesPaused)
	var i ServerSetting
	err := row.Scan(
		&i.ID,
		&i.ServerMode,
...
const setStorageID = `-- name: SetStorageID :one
...
func (q *Queries) SetStorageID(ctx context.Context, storageID string) (ServerSetting, error) {
	row := q.db.QueryRowContext(ctx, setStorageID, storageID)
	var i ServerSetting
	err := row.Scan(
		&i.ID,
		&i.ServerMode,
...
const setStorageRestoreCursor = `-- name: SetStorageRestoreCursor :exec
...
func (q *Queries) SetStorageRestoreCursor(ctx context.Context, storageRestoreCursor sql.NullInt64) error {
	_, err := q.db.ExecContext(ctx, setStorageRestoreCursor, storageRestoreCursor)
	return err
}

const setStorageScanCursor = `-- name: SetStorageScanCursor :exec
...
func (q *Queries) SetStorageScanCursor(ctx context.Context, storageScanCursor int64) error {
	_, err := q.db.ExecContext(ctx, setStorageScanCursor, storageScanCursor)
	return err
}
...
type UpsertPlaybackCacheConfigParams struct {
	...
	AutoGenerate int64 `json:"auto_generate"`
}
...
func (q *Queries) UpsertPlaybackCacheConfig(ctx context.Context, arg UpsertPlaybackCacheConfigParams) (ServerSetting, error) {
	row := q.db.QueryRowContext(ctx, upsertPlaybackCacheConfig, arg.Enabled, arg.MaxPercent, arg.AutoGenerate)
	var i ServerSetting
	err := row.Scan(
		&i.ID,
		&i.ServerMode,
...
func (q *Queries) UpsertRecordingWebhookConfig(ctx context.Context, arg UpsertRecordingWebhookConfigParams) (ServerSetting, error) {
	row := q.db.QueryRowContext(ctx, upsertRecordingWebhookConfig, arg.Enabled, arg.Url, arg.Events)
	var i ServerSetting
	err := row.Scan(
		&i.ID,
		&i.ServerMode,
