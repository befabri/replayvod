// Package videorequestservice tracks which users asked for which
// videos. Simple join-table model for now; Phase 5+ may grow this
// into a full request workflow (pending → approved → downloaded).
package videorequestservice
