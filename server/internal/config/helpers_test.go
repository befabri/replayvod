...
func TestParseOrigin(t *testing.T) {
	cases := []struct {
		...
		{"lowercases scheme and host", "HTTPS://ReplayVOD.Madata.OVH", "https://replayvod.madata.ovh"},
		{"drops default https port", "https://replayvod.madata.ovh:443", "https://replayvod.madata.ovh"},
		{"drops default http port", "http://localhost:80", "http://localhost"},
