...
func TestValidateAppConfigFieldRules(t *testing.T) {
	cases := []struct {
		...
		{"streamer wait zero clamps", func(c *AppConfig) { c.Download.StreamerRestartWaitSeconds = 0 }, func(c *AppConfig) any { return c.Download.StreamerRestartWaitSeconds }, 120},
		{"streamer wait negative clamps", func(c *AppConfig) { c.Download.StreamerRestartWaitSeconds = -1 }, func(c *AppConfig) any { return c.Download.StreamerRestartWaitSeconds }, 120},
		{"streamer wait custom stays", func(c *AppConfig) { c.Download.StreamerRestartWaitSeconds = 300 }, func(c *AppConfig) any { return c.Download.StreamerRestartWaitSeconds }, 300},
