...
func (c *Client) CreateChannelStreamScheduleSegment(ctx context.Context, params *CreateChannelStreamScheduleSegmentParams, body *CreateChannelStreamScheduleSegmentBody) ([]ChannelStreamSchedule, error) {
	var result helixResponse[ChannelStreamSchedule]
...
func (c *Client) GetChannelStreamSchedule(ctx context.Context, params *GetChannelStreamScheduleParams) ([]ChannelStreamSchedule, error) {
	var result helixResponse[ChannelStreamSchedule]
...
// SearchCategories — Gets the games or categories that match the specified query.
// GET /search/categories
// Auth: either
// https://dev.twitch.tv/docs/api/reference#search-categories
func (c *Client) SearchCategories(ctx context.Context, params *SearchCategoriesParams) ([]SearchCategory, Pagination, error) {
	var result helixResponse[SearchCategory]
	if err := c.get(ctx, "/search/categories", params, &result); err != nil {
		return nil, Pagination{}, err
	}
	return result.Data, Pagination{Cursor: result.Pagination.Cursor, Total: result.Total, TotalCost: result.TotalCost, MaxCost: result.MaxCost}, nil
}
...
func (c *Client) UpdateChannelStreamScheduleSegment(ctx context.Context, params *UpdateChannelStreamScheduleSegmentParams, body *UpdateChannelStreamScheduleSegmentBody) ([]ChannelStreamSchedule, error) {
	var result helixResponse[ChannelStreamSchedule]
