...
// SearchCategory is the response item type for search-categories.
...
type GetEventSubSubscriptionsParams struct {
	...
	ConduitID      string `url:"conduit_id,omitempty"`
	After          string `url:"after,omitempty"`
}
...
// SearchCategoriesParams are the query parameters for search-categories.
type SearchCategoriesParams struct {
	Query string `url:"query,omitempty" validate:"required"`
	First int    `url:"first,omitempty"`
	After string `url:"after,omitempty"`
}
