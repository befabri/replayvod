...
INSERT INTO sessions (hashed_id, user_id, encrypted_tokens, expires_at) VALUES ('ffe054fe7ae0cb6dc65c3af9b61d5209f439851db43d0ba5997337df154668eb', '1001', decode('', 'hex'), '2099-01-01 00:00:00');
INSERT INTO sessions (hashed_id, user_id, encrypted_tokens, expires_at) VALUES ('a0fab1377f49a759b57f63318262ebe89fabfc990e8e93ceac2984561482b9d4', '1002', decode('', 'hex'), '2099-01-01 00:00:00');
INSERT INTO sessions (hashed_id, user_id, encrypted_tokens, expires_at) VALUES ('52b6419d27bd7f547cee3b92f8c17a908b8a49601ecbec161e5030de1dfe9e0a', '1003', decode('', 'hex'), '2099-01-01 00:00:00');
SELECT setval(pg_get_serial_sequence('videos', 'id'), (SELECT MAX(id) FROM videos));
SELECT setval(pg_get_serial_sequence('video_parts', 'id'), (SELECT MAX(id) FROM video_parts));
SELECT setval(pg_get_serial_sequence('download_schedules', 'id'), (SELECT MAX(id) FROM download_schedules));
