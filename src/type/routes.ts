...
export enum ApiRoutes {
    ...
    PUT_DOWNLOAD_SCHEDULE_EDIT = "/api/download/schedule/:id",
    DELETE_DOWNLOAD_SCHEDULE = "/api/download/schedule/:id",
    GET_DOWNLOAD_SCHEDULE = "/api/download/schedule",
    POST_TOGGLE_DOWNLOAD_SCHEDULE = "/api/download/schedule/:scheduleId/toggle",
