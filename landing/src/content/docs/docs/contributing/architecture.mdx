...
| Standard tasks   | `internal/scheduler/tasks.go`  | EventSub reconcile, quota snapshot, category art/IGDB metadata sync, retention sweeps for fetch/event logs and webhook payloads, session and app-token cleanup. |
