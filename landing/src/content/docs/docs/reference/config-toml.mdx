...
Recording behaviour. Set quality on each recording or schedule; see [Recording quality](/docs/recording/#quality). The retired `preferred_quality` key had no effect and is ignored with a deprecation warning.
